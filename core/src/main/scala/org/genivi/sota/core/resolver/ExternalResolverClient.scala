...
trait ExternalResolverClient {
  ...
  /**
    ...
    */
  def resolve(namespace: Namespace, packageId: PackageId): Request[Map[Device.Id, Set[PackageId]]]
  ...
  /**
    ...
    */
  def setInstalledPackages(device: Device.Id, json: io.circe.Json) : Request[Unit]
}
...
class DefaultExternalResolverClient(baseUri : Uri, resolveUri: Uri, packagesUri: Uri, vehiclesUri: Uri)
  ...
  override def resolve(namespace: Namespace, packageId: PackageId): Request[Map[Device.Id, Set[PackageId]]] = {
  ...
  override def setInstalledPackages(device: Device.Id, json: io.circe.Json) : Request[Unit] = {
